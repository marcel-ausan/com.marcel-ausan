...
new Matcher<com.ullink.oms.model.User>()
{
    @Override
    public boolean match(com.ullink.oms.model.User user)
    {
        if (user.getPasswordSaved() == null)
            return false;
        for (com.ullink.oms.model.Password password : user.getPasswordSaved())
        {
